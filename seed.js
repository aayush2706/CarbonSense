...
async function seedData() {
  try {
    ...
    const vehicles = await Vehicle.insertMany([
      {
        registrationNumber: "MH12GK6100", owneremail:"aaryanmgiri@gmail.com", ownercontact: "9307752746", make: "Honda", model: "City",
        variant: "IVTECH", transmissions: "Manual", yearOfManufacture: 2011, fuelType: "Petrol", engineCC: 1497,
        seatingCapacity: 5, vehicleClass: "Four-Wheeler", ownerName: "Aryan Giri",
        ownerAddress: { addressLine1: "Katraj", city: "Pune", state: "Maharashtra", pincode: "411048" }, color: "Red"
      },
      {
